...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:HopeP2020@localhost:5432/fyyur2'
...
def show_venue(venue_id):
    ...
    upcoming_shows_query = db.session.query(Show).join(Artist).filter(Show.artist_id==venue_id).filter(Show.start_time>datetime.now()).all()
    upcoming_shows = []
...
def edit_artist_submission(artist_id):
    ...
    try:
        ...
        edit.state = request.form['state']
        edit.phone = request.form['phone']
        edit.genres = request.form.getlist('genres')
        edit.facebook_link = request.form['facebook_link']
        edit.image_link = request.form['image_link']
        db.session.commit()
    except:
        error = True
        db.session.rollback()
...
def edit_venue_submission(venue_id):
    ...
    try:
        ...
        edit.city = request.form['city']
        edit.state = request.form['state']
        edit.address = request.form['address']
        edit.phone = request.form['phone']
        edit.genres = request.form.getlist('genres')
        edit.facebook_link = request.form['facebook_link']
        edit.image_link = request.form['image_link']
